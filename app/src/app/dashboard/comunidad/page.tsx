...
export default async function ComunidadPage() {
  ...
  const { data: entries } = await supabase
    ...
    .select('user_id, total_xp, weekly_xp, monthly_xp, level, current_streak, rank_delta, profiles!inner(username, avatar_url, equipped_border_color, equipped_name_emoji, equipped_title_override)')
