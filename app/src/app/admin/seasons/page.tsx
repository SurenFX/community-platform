        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-4">
          ...
          <form action={createSeason} className="flex gap-2">
            <input
              ...
              required
              className="flex-1 bg-secondary border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:bor